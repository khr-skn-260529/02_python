...
#list
# 여러개 값(literal)을 묶어서 관리 (컨테이너 자료형)
...
#list update (수정)
#list[인덱스]=값 (변수에 값을 대입해 변경
lst[0]=-10
print('lst: ', lst)

#특정 인덱스 값 제거
#list.pop(index: 해당 인덱스 값 제거
...
print(len(students[0][0]))  #3(홍길동)

#str.split(구분자)
# str을 구분자를 기준으로 나눠 list형태로 반환
...
#list 슬라이실 (str 슬라이싱과 방법 동일)
print('--- list slicing ---')
texts=['hello','안녕','곤나찌와','hi']
...
#sort: 정렬
#list.sort(): 원본 라스트 내에서 정렬(in-place)
...
#d=0번 인덱스의 요소(10)
#*e=1,2번 인덱스의 요소 ([20,30])
d,*e=numbers
print(d,e)

number=[10,20,30,40,50]
a,*b,c=number #10 [20, 30, 40] 50
print(a,b,c)
