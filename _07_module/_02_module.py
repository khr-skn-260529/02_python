...
- 단, _ or __ 로 시작하는 이름은 내부용(private)이라는 관례가 있음
    -> 외부에서 import 해서 사용하는 것을 지양
- import * -> 모듈 내 모든 변수, 함수, 클래스 가져오기
           -> 단, _ or __로 시작하는 변수, 함수, 클래스는 자동으로 제외됨
"""
...
# #private 변수 가져오기 (권장 X)
# print('my_math.__z: ', my_math.__z)

"""
import *을 이용해 모두 가져오기
"""
...
#현재 모듈을 import에서 사용하는 경우 하위 코드를 실행하지 마시오
